...
const TASK_ID = 'lapRap'; // Giữ nguyên
const JOB_NAME = 'công nhân'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('lap-rap') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Lắp ráp thiết bị trên băng chuyền, nhiệm vụ dành cho công nhân!'), // **Sửa mô tả cho đúng với JOB_NAME**
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setTitle(`⚙️ ${task.name} thành công!`)
        .setColor('#708090')
        .setDescription(
          `+💧 **${xpGain} XP**\n` +
