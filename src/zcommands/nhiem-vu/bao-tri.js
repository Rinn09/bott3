...
const TASK_ID = 'baoTri'; // Giữ nguyên
const JOB_NAME = 'công nhân'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('bao-tri') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Bảo trì máy móc, nhiệm vụ dành cho công nhân!'), // **Sửa mô tả cho đúng với JOB_NAME**
