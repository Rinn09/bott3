...
const TASK_ID = 'soannGiaoAn'; // Giữ nguyên
const JOB_NAME = 'giáo viên'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('soan-giao-an') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Soạn giáo án để nâng cao chất lượng giảng dạy, nhiệm vụ dành cho giáo viên!'),
