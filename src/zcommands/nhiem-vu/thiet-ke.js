...
const TASK_ID = 'thietKe'; // Giữ nguyên
const JOB_NAME = 'kỹ sư'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('thiet-ke') // **Sửa tên lệnh thành thiet-ke**
    .setDescription('Thiết kế sản phẩm, nhiệm vụ dành cho kỹ sư!'), // **Sửa mô tả thành nhiệm vụ dành cho kỹ sư**
