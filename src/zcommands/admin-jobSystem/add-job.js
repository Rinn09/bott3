...
const { execute } = require("../job-system/apply");
...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) =>
      option
        .setName("tier")
        .setDescription("Tier của công việc (1-5)")
        .setRequired(true),
    )
    .addIntegerOption((option) =>
      option
        .setName("salary")
        .setDescription("Mức lương (VNĐ)")
        .setRequired(true),
    )
    .addIntegerOption((option) =>
      option
        .setName("cooldown")
        .setDescription("Cooldown (giờ)")
        .setRequired(true),
    )
    .addIntegerOption((option) =>
      option
        .setName("minxp")
        .setDescription("XP tối thiểu để nhận công việc")
        .setRequired(false),
    ),
