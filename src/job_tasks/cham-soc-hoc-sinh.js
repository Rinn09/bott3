...
module.exports = {
  ...
  async executeTask(interaction, user, jobDefinition, taskDefinition) {
    ...
    const cooldownTimeMs = taskCooldownFromDef || 5 * 60 * 1000;
    const xpGain = taskXpFromDef || 25; // Ví dụ XP cho chăm sóc học sinh
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor("#32CD32") // LimeGreen - màu cho giáo viên
      .setDescription(
