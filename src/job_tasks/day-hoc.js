...
module.exports = {
  ...
  async executeTask(interaction, user, jobDefinition, taskDefinition) {
    ...
    const cooldownTimeMs = taskCooldownFromDef || 10 * 60 * 1000; // Ví dụ 10 phút
    const xpGain = taskXpFromDef || 30; // Ví dụ XP cho dạy học
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor("#1E90FF") // DodgerBlue - màu cho giáo viên
      .setDescription(
