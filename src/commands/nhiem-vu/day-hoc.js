...
const TASK_ID = 'dayHoc'; // Giữ nguyên
const JOB_NAME = 'giáo viên'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('day-hoc') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Dạy học cho súc vật, nhiệm vụ dành cho giáo viên!'), // **Sửa mô tả cho đúng với JOB_NAME**
