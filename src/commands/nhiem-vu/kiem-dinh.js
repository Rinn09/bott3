...
const TASK_ID = 'kiemDinh'; // Giữ nguyên
const JOB_NAME = 'kỹ sư'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('kiem-dinh') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Kiểm định chất lượng sản phẩm, nhiệm vụ dành cho kỹ sư!'), // **Sửa mô tả cho đúng với JOB_NAME**
