...
const TASK_ID = 'thamGiaHoiThao'; // Giữ nguyên
const JOB_NAME = 'giáo viên'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('tham-gia-hoi-thao') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Tham gia hội thảo để nâng cao kiến thức, nhiệm vụ dành cho giáo viên!'),
