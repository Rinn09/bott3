...
const TASK_ID = 'capCuu'; // Giữ nguyên
const JOB_NAME = 'bác sĩ'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('cap-cuu') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Cấp cứu cho bệnh nhân, nhiệm vụ dành cho bác sĩ!'), // **Sửa mô tả cho đúng với JOB_NAME**
