...
const TASK_ID = 'thucHienXetNghiem'; // Giữ nguyên
const JOB_NAME = 'bác sĩ'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('thuc-hien-xet-nghiem') // **Sửa tên lệnh cho phù hợp với TASK_ID**
    .setDescription('Thực hiện xét nghiệm để chăm sóc sức khỏe, nhiệm vụ dành cho bác sĩ!'),
