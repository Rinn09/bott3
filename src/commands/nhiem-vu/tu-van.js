...
const TASK_ID = 'tuVan'; // Giữ nguyên
const JOB_NAME = 'bác sĩ'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('tu-van') // **Sửa tên lệnh cho phù hợp với TASK_ID**
    .setDescription('Tư vấn sức khỏe, nhiệm vụ dành cho bác sĩ!'), // **Sửa mô tả cho phù hợp với JOB_NAME**
