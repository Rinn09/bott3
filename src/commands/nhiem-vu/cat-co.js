...
const TASK_ID = 'catCo'; // Giữ nguyên
const JOB_NAME = 'nông dân'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('cat-co') // **Sửa tên lệnh cho đúng với TASK_ID**
    .setDescription('Cắt cỏ trên ruộng, nhiệm vụ dành cho nông dân!'), // **Sửa mô tả cho đúng với JOB_NAME**
