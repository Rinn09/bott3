...
const TASK_ID = 'vanChuyen'; // Giữ nguyên
const JOB_NAME = 'công nhân'; // **Sửa thành chữ thường**

module.exports = {
  data: new SlashCommandBuilder()
    .setName('van-chuyen') // **Sửa tên lệnh cho phù hợp với TASK_ID**
    .setDescription('Vận chuyển hàng hóa, nhiệm vụ dành cho công nhân!'), // **Sửa mô tả cho phù hợp với JOB_NAME**
